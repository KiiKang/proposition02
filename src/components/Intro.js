    ...
    return (
        <div className='Intro-textbox left-[50vw] top-[50vh] -translate-x-1/2 -translate-y-1/2 bg-[rgba(255,255,255,0.5)] absolute min-h-fit border-neutral-800 border-2 w-[440px] p-[20px] pb-2'>
            ...
            <div className='Intro-textbox-p max-h-[500px] overflow-y-scroll text-neutral-800 text-sm tracking-wide'
                ...
                <p>
                    <b>Archive Reindex Archive (ARA)</b> is a web-based platform that presents a collection of photographic archives from National Geographic Magazine issues dating from 1945 to 1955, where visitors can leave annotations on “what they see.” The images are masked with a fungus-like layer that represents how a machine sees them, aiming to reassemble the perception of the internalized movements of general viewers’ eyes upon encountering the images for the first time.
                </p>
                    
                    <p>
                        
                        <b>ARA</b> unearths archived remnants
                    of the aftermath of WWII—“expeditious” human movements of global colonization and imperialization; disproportionate distribution of raw materials, human resources and capital. It collects contemporary
                    ...
                    Sunyoung Kang</a> and Kii (Wonki) Kang, bringing together Ivetta’s interests in linguistics, poetics, and ethnographic indexicality with Kii’s critical explorations of computation and embodied semantics.


            </p><p>

                <b>ARA</b> also serves as a platform for growing collections of texts, where authors, 
                poets, and writers respond to the latent concepts and emotions embedded in the archive—those
                that have surfaced, lingered, or remained deeply entwined with the artists throughout the creation process.
                </p>
